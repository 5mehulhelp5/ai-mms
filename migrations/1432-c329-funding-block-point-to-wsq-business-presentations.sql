-- C329 (Generative AI for Business Presentation) — create the Funding block and
-- point it at its own WSQ twin.
--
-- C329 is the non-WSQ duplicate of TGS-2026061325 "WSQ - Generative AI for
-- Business Presentations" (courseware duplicated 2026-09-19). The course had no
-- course_C329_funding_and_grant block at all, so the product page showed nothing
...
--   https://www.tertiarycourses.com.sg/wsq-generative-ai-for-business-presentations.html
--
...
SELECT
  'Course C329 - Funding And Grant',
  'course_C329_funding_and_grant',
  '<p>No funding is available for this course</p> <p>For WSQ funding, please checkout the details at&nbsp;<span style="text-decoration: underline;"><a href="https://www.tertiarycourses.com.sg/wsq-generative-ai-for-business-presentations.html" title="WSQ - Generative AI for Business Presentations">WSQ - Generative AI for Business Presentations</a></span></p>',
  NOW(), NOW(), 1
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM (SELECT block_id FROM cms_block WHERE identifier = 'course_C329_funding_and_grant') AS existing
);
...
UPDATE cms_block
   SET content = '<p>No funding is available for this course</p> <p>For WSQ funding, please checkout the details at&nbsp;<span style="text-decoration: underline;"><a href="https://www.tertiarycourses.com.sg/wsq-generative-ai-for-business-presentations.html" title="WSQ - Generative AI for Business Presentations">WSQ - Generative AI for Business Presentations</a></span></p>',
       is_active = 1,
       update_time = NOW()
 WHERE identifier = 'course_C329_funding_and_grant';

INSERT IGNORE INTO cms_block_store (block_id, store_id)
SELECT block_id, 0 FROM cms_block WHERE identifier = 'course_C329_funding_and_grant';
