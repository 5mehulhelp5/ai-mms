...
-- "\n" sequence, which MySQL stored verbatim. The storefront then rendered a
-- stray "\n" between each paragraph of "What's This Course About" and the
-- course topics (visible on the live page and in the admin Course Description
-- editor). The WSQ parent TGS-2024049212 has none of these.
--
...
-- generating this file). Escaping here is round-trip checked: only backslash
-- and single-quote are escaped, and real newlines are written raw.
--
