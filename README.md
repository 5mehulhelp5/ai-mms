...
| **CourseImage** | AI cover-image renderer + funding-badge tags (the same tags drive the storefront chips, the cover, the WSQ Funding card, and the Free AI Tools Subscription perk card). |
