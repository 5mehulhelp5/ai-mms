...
You will create keywords-rich SEO meta title, keywords, description, course description and job roles for the following HRD Corp funded course offered in Malaysia.
...
- Add "HRD Corp Funded" as the prefix in meta title (before the course name)
...
- The meta title MUST end with the exact suffix "| Tertiary Courses Malaysia"
- Mention HRDC claim eligibility in the meta description

Your output format is as follows:
1. **SEO Meta Title:** HRD Corp Funded .... | Tertiary Courses Malaysia
2. **SEO Meta Keywords:**
3. **SEO Meta Description:** (append "HRDC claimable under SBL Khas.")
